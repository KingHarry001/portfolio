...
const ProjectFormModal = ({ editingItem, setShowModal, onSuccess, onError }) => {
        ...
        <div onSubmit={handleSubmit}>
          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              {formData.image ? (
                <div className="relative">
                  <img src={formData.image} alt="Preview" className="w-full h-32 sm:h-48 object-cover rounded-lg" />
                  <button
                    type="button"
                ...
                <label className="border-2 border-dashed border-gray-700 rounded-lg p-4 sm:p-8 text-center hover:border-cyan-500 transition-colors cursor-pointer block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2">Drop image here or click to upload</p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 sm:p-4 bg-gray-800 rounded-lg gap-2 sm:gap-0">
              <div>
                <p className="font-medium text-white text-sm sm:text-base">Featured Project</p>
                <p className="text-xs sm:text-sm text-gray-400">Display on homepage</p>
              </div>
