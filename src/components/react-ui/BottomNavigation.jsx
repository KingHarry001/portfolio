...
import { Menu, X, ChevronUp, Home, User, Briefcase, FileText, MessageSquare, LogIn, LogOut, Shield, Mail, Settings } from "lucide-react";
...
export default function BottomNavigation() {
  ...
  const homeSections = [
    ...
    { id: "testimonial", name: "Testimonials", icon: MessageSquare, href: "#testimonial" },
            ...
            <div className="relative w-16 h-16">
                    ...
                    <UserButton 
                      ...
                      appearance={{
                        elements: {
                          ...
                          userButtonPopoverCard: "bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-2xl",
                          userButtonPopoverActions: "border-t border-gray-200 dark:border-gray-800",
              ...
              {scrollProgress > 5 && scrollProgress < 95 && (
                <div className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-white dark:bg-gray-900 border border-white/30 dark:border-gray-700 flex items-center justify-center shadow-sm">
                  <span className="text-[8px] font-bold" style={{ color: themeColor }}>
                      ...
                      {isSignedIn ? (
                        <>
                          ...
                          >
                            ...
                            <span className="text-sm flex-1">Manage Account</span>
                          </button>
                        ...
                        <>
                          ...
                          >
                            ...
                            <span className="text-sm font-medium flex-1">Hire Me</span>
                          </button>
                        </>
                      )}
                    </div>
                  ...
                  <>
                    {mainNavItems.map((item) => (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 p-4 hover:bg-white/30 dark:hover:bg-gray-800/50 transition-all duration-200 text-left text-gray-800 dark:text-gray-200 group ${
                          pathname === item.href ? 'bg-white/20 dark:bg-gray-800' : ''
                        }`}
                      >
