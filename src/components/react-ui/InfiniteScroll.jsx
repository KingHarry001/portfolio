...
export default function InfiniteScroll({
  ...
  const renderContent = (item, index) => {
    // If content is a string and looks like an image URL
    ...
    // If content is JSX (React element)
    if (typeof item.content === 'object' && item.content.props) {
      return item.content;
    }
        ...
        >
          {items.map((item, i) => (
            <div
              ...
              className="flex items-center justify-center p-2 text-xl text-white font-semibold text-center border-2 border-white rounded-[15px] select-none box-border relative overflow-hidden"
              style={{
